...
/**
 * This class provides static utility public static functions that will be used by the WPS samples
 */
class Utils
{
	/**
	 ...
	 * @static
	 */
	public static function PPHttpPost($url_, $postFields_, $parsed_)
	{
	 ...
	 * @static
	 */
	public static function PPError($error_msg, $error_no) {
