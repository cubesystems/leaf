...
class EWPServices
{
	 ...
	 * @static
	 */
	public static function encryptButton(
		$buttonParams_,
		$ewpCertPath_,
		$ewpPrivateKeyPath_,
		$ewpPrivateKeyPwd_,
	...
	)
	{
		...
		$encryptedButton = '<FORM ACTION=' . $destinationUrl_ . '/cgi-bin/webscr" METHOD="post">
...
<INPUT TYPE="image" SRC="' . $buttonImageUrl_ . '" BORDER="0" NAME="submit" ALT="Make Payments with PayPal -- it\'s fast, free and secure!">
		...
		return array ('status' => true, 'encryptedButton' => $encryptedButton, 'encryptedData' => $encryptedData, );
	}
